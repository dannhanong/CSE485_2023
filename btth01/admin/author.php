...
<main class="container mt-5 mb-5">
    <div class="row">
        <div class="col-sm">
            <a href="author/addAuthor.php" class="btn btn-success">Thêm mới</a>
            <table class="table">
                <thead>
                    <tr>
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="author/edit_author.php?id=<?php echo $row['ma_tgia']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                                <td>
                                    <a href="#" onclick=confirmDelete(<?php echo $row['ma_tgia']; ?>)><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
    ...
    <script>
        function confirmDelete(authorId) {
            if (confirm('Bạn có chắc muốn xóa không?')) {
                window.location.href = 'author/deleteAuthor.php?id=' + authorId;
            }
        }
    </script>
